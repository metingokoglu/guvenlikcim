...
<body>
	...
	<table class="table" cellpadding="0" cellspacing="0">
		...
		<tr class="icbaslik">
			<td colspan="6">ONARIM BİLGİLERİ</td>
		</tr>
		<tr class="trclass2">
			<td class="w150">YAPILAN ONARIM</td>
			<td class="w1">:</td>
			<td class="w2"><?=$conf["yapilan_islem"];?></td>
			<td class="w150">ONARIM ÜCRETİ</td>
			<td class="w1">:</td>
			<td class="w243"><?=$conf["fiyat"];?> TL</td>
		</tr>
	</table>
