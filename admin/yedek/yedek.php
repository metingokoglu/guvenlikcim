...
define("DB_USER", 'arlinmzi_metin');
define("DB_PASSWORD", 'Metin_2272609');
define("DB_NAME", 'arlinmzi_guvenlikcim');
...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
        ...
        $this->backupFile              = 'guvenlik-cim-veritabani-yedek-dosyasi'.date("Ymd_His", time()).'.sql';
    ...
    protected function gzipBackupFile($level = 9) {
        ...
        $dest =  $source . '.gz';
        include '../../baglan.php';
        mysqli_query($con,"insert into yedek (dosya_yolu) values ('$dest')");
