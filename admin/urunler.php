                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Ürün Yükleme Formu</h5>
                                                       
                                                    </div>
                                                    <div class="card-block">
                                                        <h4 class="sub-title">Ürün</h4>
                                                        <form action="urunyukle.php" method="post" enctype="multipart/form-data">
                                                          
                                                            <div class="form-group row">
                                                                <label class="col-form-label" style="width:100px;margin-left:15px;">Ürün Açıklama :</label>
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    placeholder="Ürün Açıklaması">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label class="col-form-label" style="width:100px;margin-left:15px;">Resim Seç :</label>
                                                                            <div class="col-sm-4">
